...
<head>
    ...
    <script type="text/javascript" src="/resources/lib/jqwidgets/jqxsortable.js"></script>
    <script type="text/javascript" src="/resources/lib/jqwidgets/jqxkanban.js"></script>
