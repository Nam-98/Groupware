   ...
   <div id=container>
      ...
      <div class="menuButtons row">
               ...
               <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="쪽지함" href="/message/msgInBoxList.message">쪽지함</a></li>
         ...
         <div class="col-1 iconbox d-lg-inline d-none">
            ...
            <h6>쪽지함</h6><input type=hidden value="/message/msgInBoxList.message">
         </div>
         <div class="col-1 iconbox d-lg-inline d-none">
