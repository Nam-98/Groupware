				...
				<div class="container-fluid">
						...
						<div class="col-md-2">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">${sessionScope.id}님</h3>
									<div class="right">
								...
								<div class="panel-body no-padding profilBox">
									<img class="profileImg img-thumbnail" alt=""
										src="/resources/profileImage/${sessionScope.id}.png">
									<button id="logout" class="btn btn-gray btn-xs" type="button">Logout</button>
									<button class="btn btn-yellow btn-xs">My Info</button>
								</div>
							</div>
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">STJ 메인메뉴 바로가기</p>
						</div>
