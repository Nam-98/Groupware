...
public class MemberDTO {
	...
	public MemberDTO(String id, String password, String name, Date birth, String gender, String contact,
			String address1, String address2, String zip_code, String is_married, String dept_code,
			String position_code, Date reg_date, Date retire_date, int access_level_code, double break_total_count,
			double break_use_count) {
		super();
		this.id = id;
		this.password = password;
		this.name = name;
